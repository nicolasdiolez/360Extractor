...
# core can import them without pulling in the AI stack; re-exported here for
# backward compatibility.
from extractor360.core.ai_classes import (  # noqa: F401
    AI_MODEL_VARIANTS,
    DEFAULT_AI_MODEL,
...
class AIService:
    ...
    def __init__(self, model_name=DEFAULT_AI_MODEL):
        """
        Initialize the AI model.
        """
        # Remember which model was loaded so callers can cache / avoid reloads.
