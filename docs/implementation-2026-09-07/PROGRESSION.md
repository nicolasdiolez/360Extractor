...
Les guides CLI/réglages, le README, les instructions de contribution et les notes Unreleased ont été harmonisés avec le code de correction. Le [protocole de recette](../CLI_TESTING_PROTOCOL.md) couvre Studio, CLI, GPS, reconstruction et binaires téléchargés ; la [feuille de route](../../IMPROVEMENTS.md) distingue les corrections réalisées des chantiers ouverts. Les rapports et résultats datés restent des preuves historiques ; la validation locale ci-dessus concerne la révision testée, pas une future release. La [CI du commit 82cf24a](https://github.com/nicolasdiolez/360Extractor/actions/runs/34151336481) a ensuite réussi, y compris les jobs multiplateformes configurés. Le candidat suivant est préparé en version 4.0.0, datée du 7 septembre 2026, après un essai rapide jugé positif par le mainteneur. Cet essai ne remplace pas les qualifications encore ouvertes.
...
## Préparation de la version 4.0.0

Le mainteneur a signalé un essai rapide positif et demandé de préparer la fusion vers main. La version, les notes et le README sont préparés pour 4.0.0 ; le choix majeur correspond au changement des imports Python et à la nouvelle interface Studio. La capture du README est produite par les vrais widgets de l’application avec un panorama synthétique, sans retoucher les résultats affichés. Les anciens rapports conservent les numéros et résultats de leurs révisions respectives. La disponibilité des binaires et la publication doivent être vérifiées sur la release GitHub correspondante.
